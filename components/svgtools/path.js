...
export default function Path({ id, index, dispatch, setMeasurementCollapsed }) {

    function handleSelect() {
        dispatch({ type: SVG_ACTION_TYPES.DEL_PATH, payload: id })
    ...
    return (
        <Draggable draggableId={id} index={index}>
            {(provided) => (
                ...
                >
                    <div
                        className="bg-slate-200 flex items-center outline-2 outline-slate-700 hover:outline active:outline active:outline-info focus:outline w-full h-10"
                    ...
                    >
                        ...
                        <div className="h-full">
                            <button type="button" className="text-slate-500 hover:text-danger p-1" onClick={handleSelect}>
